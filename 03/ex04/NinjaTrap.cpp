...
/*   Updated: 2021/04/23 15:20:32 by edal--ce         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "NinjaTrap.hpp"

NinjaTrap::NinjaTrap(std::string name) : ClapTrap(60, 120, 1, name, "N1NJ4-TP", 60, 5, 0)
{
	std::cout << "N1NJ4-TP " << _name << " has entered the game" << std::endl;
}

NinjaTrap::~NinjaTrap()
{
	std::cout << "N1NJ4-TP "<< _name << " left the game" << std::endl;
}
